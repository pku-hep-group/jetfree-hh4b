...
Usage:
    python -m utils.convert_to_parquet /data/input_dir/*.root -o /data/output_dir/
    python -m utils.convert_to_parquet filelist.txt -o /data/output_dir/ --data-config config.yaml
    python -m utils.convert_to_parquet /data/input_dir/*.root -o /data/output_dir/ --compression zstd --row-group-size 5000
"""
